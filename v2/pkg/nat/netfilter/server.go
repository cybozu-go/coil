...
func (n *NatServer) initIPv4() error {
	...
	case BackendIptables:
		if err := setIPTablesMasqRules(iptables.ProtocolIPv4, n.iface, n.ipv4); err != nil {
			return err
		}
	case BackendNftables:
		if err := setNFTablesMasqRules(nftables.TableFamilyIPv4, n.iface, n.ipv4); err != nil {
			return err
		}
	default:
...
func (n *NatServer) initIPv6() error {
	switch n.backend {
	case BackendIptables:
		if err := setIPTablesMasqRules(iptables.ProtocolIPv6, n.iface, n.ipv6); err != nil {
			return err
		}
	case BackendNftables:
		if err := setNFTablesMasqRules(nftables.TableFamilyIPv6, n.iface, n.ipv6); err != nil {
			return err
		}
	default:
		return fmt.Errorf("invalid nat backend: %s", n.backend)
