...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EgressPDB) DeepCopyInto(out *EgressPDB) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EgressPDB.
func (in *EgressPDB) DeepCopy() *EgressPDB {
	if in == nil {
		return nil
	}
	out := new(EgressPDB)
